...
void cSprite::setBoundingRect(RECT* pRect)
{
	...
	theBoundingRect.top = sPos.y - (textureWidth / 2);
	theBoundingRect.right = textureWidth + theBoundingRect.left;   
	theBoundingRect.bottom = textureHeight + theBoundingRect.top;
