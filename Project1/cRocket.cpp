...
void cRocket::update(float deltaTime)
{
	...
	if (m_InputMgr->isKeyDown(VK_SPACE))
	{
		...
		theRocketBullets[numBullets]->setSpriteTranslation(glm::vec2(2700.0f, 10.0f));
		...
		theRocketBullets[numBullets]->setBulletVelocity(glm::vec2(2700.0f, 0.0f));
	...
	//Rocket sprite rotation
	if (spriteRotation > 360)
	{
		spriteRotation -= 360.0f;
	}

	//Rocket sprite velocity and speed
